    ...
    */
    ...
    function create_then_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*title*/ 1 && t_value !== (t_value = /*result*/ ctx[1] + "")) set_data_dev(t, t_value);
    		},
    ...
    function create_pending_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(16:22)              Wait a sec...         {:then result}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	handle_promise(promise = /*title*/ ctx[0], info);
    ...
    `;
    			...
    			t5 = text("\n    ");
    			add_location(h2, file$2, 14, 4, 306);
    			attr_dev(code, "data-line-numbers", "");
    			attr_dev(code, "data-trim", "");
    			attr_dev(code, "data-no-escape", "");
    			add_location(code, file$2, 23, 4, 446);
    			add_location(pre, file$2, 22, 4, 436);
    			add_location(section, file$2, 13, 0, 292);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			info.block.m(h2, info.anchor = null);
    			info.mount = () => h2;
    			info.anchor = null;
    		...
    		p: function update(new_ctx, [dirty]) {
    			...
    			if (dirty & /*title*/ 1 && promise !== (promise = /*title*/ ctx[0]) && handle_promise(promise, info)) ; else {
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	onMount(() => {
    		...
    		$$invalidate(0, title = new Promise(resolve => {
    				setTimeout(() => resolve('Whats nice together?'), 5000);
    			}));
    	});
    	...
    	$$self.$capture_state = () => ({ onMount, title });
    ...
    /* src/slides/Video.svelte generated by Svelte v3.49.0 */

    const file$1 = "src/slides/Video.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			ul = element("ul");
    			li0 = element("li");
    			t2 = text("Configure your Presentation in ");
    			code0 = element("code");
    			code0.textContent = "config.js";
    			t4 = space();
    			li1 = element("li");
    			t5 = text("Create your Slides in ");
    			code1 = element("code");
    			code1.textContent = "src/slides";
    			t7 = space();
    			li2 = element("li");
    			t8 = text("Add your Slides in ");
    			code2 = element("code");
    			code2.textContent = "Presentation.svelte";
    			t10 = space();
    			aside = element("aside");
    			aside.textContent = "This is an example of slide notes";
    			add_location(h2, file$1, 5, 4, 35);
    			add_location(code0, file$1, 7, 68, 137);
    			attr_dev(li0, "class", "fragment fade-up");
    			add_location(li0, file$1, 7, 8, 77);
    			add_location(code1, file$1, 8, 59, 224);
    			attr_dev(li1, "class", "fragment fade-up");
    			add_location(li1, file$1, 8, 8, 173);
    			add_location(code2, file$1, 9, 56, 309);
    			attr_dev(li2, "class", "fragment fade-up");
    			add_location(li2, file$1, 9, 8, 261);
    			add_location(ul, file$1, 6, 4, 64);
    			attr_dev(aside, "class", "notes");
    			add_location(aside, file$1, 11, 2, 359);
    ...
    /* src/Presentation.svelte generated by Svelte v3.49.0 */
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Poster, Video });
    	return [];
    }
    ...
    function create_fragment(ctx) {
    	...
    	let presentation;
    	let current;
    	document.title = title_value = /*app*/ ctx[0].name;
    	presentation = new Presentation({ $$inline: true });
    	...
    	const block = {
    		c: function create() {
    			...
    			div1 = element("div");
    			div0 = element("div");
    			create_component(presentation.$$.fragment);
    			attr_dev(div0, "class", "slides");
    			add_location(div0, file, 23, 4, 466);
    			attr_dev(div1, "class", "reveal");
    			add_location(div1, file, 22, 0, 441);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(presentation, div0, null);
    			current = true;
    		},
    		p: function update(ctx, [dirty]) {
    			if ((!current || dirty & /*app*/ 1) && title_value !== (title_value = /*app*/ ctx[0].name)) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	onMount(async () => {
    		await tick();
    		const deck = new W(reveal);
    		deck.initialize();
    	});

    	const writable_props = ['app', 'reveal'];
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { app: 0, reveal: 1 });
    		...
    		if (/*reveal*/ ctx[1] === undefined && !('reveal' in props)) {
    			console.warn("<App> was created without expected prop 'reveal'");
    		}
    	}
